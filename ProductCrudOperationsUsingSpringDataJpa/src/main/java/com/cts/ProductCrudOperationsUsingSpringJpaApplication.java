...
public class ProductCrudOperationsUsingSpringJpaApplication {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("8.Get All Products Above");
			...
			case 7:
				...
				break;
			case 8:
				System.out.println("Enter the product above");
				intialPrice = scanner.nextInt();
				products = service.getAllProductsAbove(intialPrice);
				for (Product pro : products) {
					System.out.println(pro);
				}
				break;
